...
use App\Filament\Home\Resources\ChannelResource\RelationManagers\CategoryRelationManager;
...
//                    ->sortable()->searchable()->toggleable(),
    ...
    {
        return [
            'index' => \App\Filament\Home\Resources\ChannelResource\Pages\ListChannels::route('/'),
            'create' => \App\Filament\Home\Resources\ChannelResource\Pages\CreateChannel::route('/create'),
            'view' => \App\Filament\Home\Resources\ChannelResource\Pages\ViewChannel::route('/{record}'),
            'edit' => \App\Filament\Home\Resources\ChannelResource\Pages\EditChannel::route('/{record}/edit'),
        ];
    }
