...
//                    Tables\Actions\ForceDeleteBulkAction::make(),
    ...
    {
        return [
            'index' => \App\Filament\Home\Resources\GuildResource\Pages\ListGuilds::route('/'),
            'create' => \App\Filament\Home\Resources\GuildResource\Pages\CreateGuild::route('/create'),
            'view' => \App\Filament\Home\Resources\GuildResource\Pages\ViewGuild::route('/{record}'),
            'edit' => \App\Filament\Home\Resources\GuildResource\Pages\EditGuild::route('/{record}/edit'),
        ];
    }
