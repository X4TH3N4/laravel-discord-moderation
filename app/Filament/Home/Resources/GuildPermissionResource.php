...
//                    Tables\Actions\ForceDeleteBulkAction::make(),
    ...
    {
        return [
            'index' => \App\Filament\Home\Resources\GuildPermissionResource\Pages\ListGuildPermissions::route('/'),
            'create' => \App\Filament\Home\Resources\GuildPermissionResource\Pages\CreateGuildPermission::route('/create'),
            'view' => \App\Filament\Home\Resources\GuildPermissionResource\Pages\ViewGuildPermission::route('/{record}'),
            'edit' => \App\Filament\Home\Resources\GuildPermissionResource\Pages\EditGuildPermission::route('/{record}/edit'),
        ];
    }
