...
//                Tables\Actions\CreateAction::make(),
    ...
    {
        return [
            'index' => \App\Filament\Roof\Resources\MemberResource\Pages\ListMembers::route('/'),
            'create' => \App\Filament\Roof\Resources\MemberResource\Pages\CreateMember::route('/create'),
            'view' => \App\Filament\Roof\Resources\MemberResource\Pages\ViewMember::route('/{record}'),
            'edit' => \App\Filament\Roof\Resources\MemberResource\Pages\EditMember::route('/{record}/edit'),
        ];
    }
